...
public class DatabasesConfigurationsLoader {

	private DatabasesConfigurationsLoader() {	
	}
	 ...
	 * @return
	 */
	public static DatabasesConfigurations loadDatabasesConfigurationsOLD( TelosysToolsCfg telosysToolsCfg ) 
	{
	...
	public static DatabasesConfigurations loadDatabasesConfigurations( TelosysToolsCfg telosysToolsCfg ) throws TelosysToolsException
	{
