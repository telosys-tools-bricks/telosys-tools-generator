...
// $jdbc.preparedStatementSetter($attribute)  : not used
// $jdbc.resultSetGetter($attribute) : not used
// $jdbc.valueForPreparedStatement($attribute,${recordInstance}) : not used
// => removed in v 4.1.0
//-------------------------------------------------------------------------------------
